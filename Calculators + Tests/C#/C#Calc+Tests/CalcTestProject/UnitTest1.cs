...
namespace CalcTestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void TestSubtraction5()
        {
            ...
            calc.EnterDigit("1");
            calc.ExecuteOperation();
            Assert.AreEqual("3.8", calc.getResult());
        }
        [TestMethod]
        ...
        public void TestSubtraction12()
        {
            ...
            calc.ExecuteOperation();
            Assert.AreEqual("21274.247", calc.getResult());
        }
        [TestMethod]
        ...
        public void TestSubtraction14()
        {
            ...
            calc.ExecuteOperation();
            Assert.AreEqual("-234456,4", calc.getResult());
        }
        [TestMethod]
        ...
        public void TestAddition11()
        {
            ...
            Assert.AreEqual("0.0000001", calc.getResult());
        }
        ...
        [TestMethod]
        public void TestAdditionMulti7()
        {
            var calc = new CalcLogic();
        ...
        public void TestAdditionDiv6()
        {
            ...
            Assert.AreEqual("3.7073170", calc.getResult());
        }
        [TestMethod]
